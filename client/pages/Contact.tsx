...
const faqs = [
  {
    ...
    answer:
      "Absolutely! We offer vegetarian, vegan, gluten-free, and dairy-free options. Please inform us of any allergies when making your reservation.",
  },
  {
    question: "What is your cancellation policy?",
    answer:
      "We require at least 24 hours notice for cancellations. For parties of 8 or more, we require 48 hours notice.",
  },
  {
    question: "Do you offer private dining?",
    answer:
      "Yes! We have a private dining room that seats up to 20 guests, perfect for special occasions and business meetings.",
  },
  {
    question: "Is there parking available?",
    answer:
      "We offer complimentary valet parking for all our guests. Street parking is also available nearby.",
  },
  {
    question: "Can I bring my own wine?",
    answer:
      "We allow BYOB with a corkage fee of ₹1,500 per bottle. Our sommelier can also recommend wines from our extensive collection.",
  },
];
      ...
      <section className="py-16 bg-gradient-to-r from-primary/5 to-gold/5">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            ...
            requests, or just want to say hello, we're here to help.
          </p>
        ...
        <section className="mt-16">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              The passionate individuals behind every memorable dining
              experience
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {teamMembers.map((member, index) => (
              <Card
                key={index}
                className="text-center border-gold/20 hover:border-gold/40 transition-all duration-300"
              >
          ...
          <Card className="bg-gradient-to-r from-primary to-gold text-primary-foreground border-0">
            <CardContent className="p-12">
              <h2 className="text-2xl md:text-4xl font-bold mb-4">
                Ready to Visit Butterfly Garden?
              </h2>
              <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
                Join us for an unforgettable culinary experience in the heart of
                the city
              </p>
